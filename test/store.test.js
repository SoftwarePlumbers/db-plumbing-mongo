...
const { Store, Client } = require( '../store');
...
describe('Store', () => {
    ...
    it('creates and retrieves test object in store', (done) => {
        let client = new MongoClient("mongodb://mongo1.softwareplumbers.net:27017/maximally-me");
        let store = client.getStore("testsimple", Simple, INDEX_MAP);
